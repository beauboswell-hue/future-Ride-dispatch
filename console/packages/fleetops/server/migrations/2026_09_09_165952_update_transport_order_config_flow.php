        ...
        foreach ($configs as $config) {
            ...
            $newFlow = [
                ...
                'enroute' => [
                    ...
                    'name'        => 'En Route',
                    'status'      => 'En Route',
                    'color'       => data_get($currentFlow, 'enroute.color', data_get($currentFlow, 'enroute_pickup.color', '#EAB308')),
                    'logic'       => data_get($currentFlow, 'enroute.logic', data_get($currentFlow, 'enroute_pickup.logic', [])),
                    'events'      => data_get($currentFlow, 'enroute.events', data_get($currentFlow, 'enroute_pickup.events', [])),
                    'actions'     => data_get($currentFlow, 'enroute.actions', data_get($currentFlow, 'enroute_pickup.actions', [])),
                    'details'     => data_get($currentFlow, 'enroute.details', data_get($currentFlow, 'enroute_pickup.details', 'En route to pickup')),
                    'options'     => data_get($currentFlow, 'enroute.options', data_get($currentFlow, 'enroute_pickup.options', [])),
                    'complete'    => false,
                    'entities'    => data_get($currentFlow, 'enroute.entities', data_get($currentFlow, 'enroute_pickup.entities', [])),
                    'sequence'    => 2,
                    'activities'  => ['on_location'],
                    'internalId'  => data_get($currentFlow, 'enroute.internalId', data_get($currentFlow, 'enroute_pickup.internalId', (string) Str::uuid())),
                    'pod_method'  => data_get($currentFlow, 'enroute.pod_method', data_get($currentFlow, 'enroute_pickup.pod_method', 'scan')),
                    'require_pod' => data_get($currentFlow, 'enroute.require_pod', data_get($currentFlow, 'enroute_pickup.require_pod', false)),
                ],
                'on_location' => [
                    'key'         => 'on_location',
                    'code'        => 'on_location',
